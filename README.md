...
2. **mediapipe** -> to detect and track the hands on the screen, getting the hand landmarks.
3. **numpy** -> for performing array operations.
4. **pytorch** -> for creating the CNN which performs the image classification tasks. 
